...
# -*- coding: utf-8 -*-
"""
Scaffold-split training experiment — 5 random seeds.

Data:   data/json_splits/json_splits/data.csv
Split:  data/scaffold_splits/scaffold_split.json  (train/val/test)
...
SPLIT_JSON = os.path.join(PROJECT_ROOT, 'data', 'splits', 'scaffold', 'split.json')
...
def main():
    ...
    print('\nDone. Run run_scaffold_analysis.py to generate reports.')
